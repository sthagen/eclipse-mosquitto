...
TEST_F(CtrlShellHelpTest, DynsecHelp)
{
	...
	const char *outputs[] = {
		...
		"addRoleACL <rolename> publishClientReceive allow|deny <topic>\n",
			"addRoleACL <rolename> publishClientSend allow|deny <topic>\n",
			"addRoleACL <rolename> subscribeLiteral allow|deny <topic>\n",
			"addRoleACL <rolename> subscribePattern allow|deny <topic>\n",
			"addRoleACL <rolename> unsubscribeLiteral allow|deny <topic>\n",
			"addRoleACL <rolename> unsubscribePattern allow|deny <topic>\n",
